...
const StatCard: React.FC<{ icon: React.ReactNode; label: string; value: string | number; sub?: string; color?: string }> = ({ icon, label, value, sub, color = 'text-white' }) => (
    <div className="bg-slate-800/50 p-6 rounded-lg flex items-center gap-4 border border-slate-700/80 text-center flex-col justify-center h-full">
            ...
            <div className="overflow-x-auto">
                ...
                <tbody>
                    ...
                    <tr key={segment.EdgeId} className="border-b border-slate-700/80 hover:bg-slate-800/50 transition-colors">
                        ...
                        <td className="px-2 sm:px-6 py-4 text-center font-bold text-red-400" style={{textShadow: '0 0 5px rgba(239, 68, 68, 0.5)'}}>
